...
const PopupPelajaran: React.FC<{ isVisible: boolean; onClose: () => void }> = ({
  isVisible,
  onClose,
}) => {
  return (
...
const PopupTutorPopuler: React.FC<{
  isVisible: boolean
  onClose: () => void
}> = ({ isVisible, onClose }) => {
  return (
...
const PopupKelasPopuler: React.FC<{
  isVisible: boolean
  onClose: () => void
}> = ({ isVisible, onClose }) => {
  return (
...
const LandingPage: React.FC = () => {
  ...
  const [isTutorPopulerModalVisible, setTutorPopulerModalVisible] =
    useState(false)
  const [isKelasPopulerModalVisible, setKelasPopulerModalVisible] =
    useState(false)
  ...
  return (
    <ScrollView style={styles.container}>
        ...
        <View style={styles.headerContent}>
          <View style={styles.greetingContainer}>
            ...
            <Text style={styles.subGreeting}>
              Pilih pelajaran dan mulai bersenang-senang
            </Text>
          </View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.lessonItem}>
            <View style={styles.lessonIconBackground}>
              <Image
                source={require("../../assets/images/komputer.png")}
          ...
          <View style={styles.lessonItem}>
            <View style={styles.lessonIconBackground}>
              <Image
                source={require("../../assets/images/kesenian.png")}
                style={styles.lessonIcon}
              />
            </View>
          ...
          <View style={styles.lessonItem}>
            <View style={styles.lessonIconBackground}>
              <Image
                source={require("../../assets/images/kimia.png")}
                style={styles.lessonIcon}
              />
            </View>
          ...
          <View style={styles.lessonItem}>
            <View style={styles.lessonIconBackground}>
              <Image
                source={require("../../assets/images/kesehatan.png")}
                style={styles.lessonIcon}
              />
            </View>
          ...
          <View style={styles.lessonItem}>
            <View style={styles.lessonIconBackground}>
              <Image
                source={require("../../assets/images/musik.png")}
                style={styles.lessonIcon}
              />
            </View>
      ...
      <View style={styles.section}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.tutorItem}>
            <Image
              source={require("../../assets/images/tutor_populer1.png")}
          ...
          <View style={styles.tutorItem}>
            <Image
              source={require("../../assets/images/tutor_populer2.png")}
              style={styles.tutorImage}
            />
          ...
          <View style={styles.tutorItem}>
            <Image
              source={require("../../assets/images/tutor_populer3.png")}
              style={styles.tutorImage}
            />
      ...
      <View style={styles.section}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.classItem}>
            <Image
              source={require("../../assets/images/kelas_populer1.png")}
          ...
          <View style={styles.classItem}>
            <Image
              source={require("../../assets/images/kelas_populer2.png")}
              style={styles.classImage}
            />
          ...
          <View style={styles.classItem}>
            <Image
              source={require("../../assets/images/kelas_populer3.png")}
              style={styles.classImage}
            />
      ...
      <PopupPelajaran
        isVisible={isPelajaranModalVisible}
        onClose={closePelajaranModal}
      />
      <PopupTutorPopuler
        isVisible={isTutorPopulerModalVisible}
        onClose={closeTutorPopulerModal}
      />
      <PopupKelasPopuler
        isVisible={isKelasPopulerModalVisible}
        onClose={closeKelasPopulerModal}
      />
    </ScrollView>
  )
}
